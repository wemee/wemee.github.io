...
function drawIndices() {
  ...
  tableHtmlStr += "<tr style='background-color: " + colors['tableBackgroundColor'][2] + "'><td align='center'>​魚群指數</td>" + fishIndexHtmlStr + "</tr>";
  tableHtmlStr += "<tr style='background-color: " + colors['tableBackgroundColor'][3] + "'><td align='center'>捕獲​指數</td>" + catchIndexHtmlStr + "</tr>";
  tableHtmlStr += "</table>"
